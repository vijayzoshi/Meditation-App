...
public class CategoryAdepter extends RecyclerView.Adapter<CategoryAdepter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            ...
            card_total = (TextView) view.findViewById(R.id.card_total);
            bottomHolder = (RelativeLayout) view.findViewById(R.id.bottomHolder);
            rlitem = (RelativeLayout) view.findViewById(R.id.rlitem);
        }
    }

    public CategoryAdepter(Context ctx, int type, List<Category> recentslyPlayed, RecycleviewClickLisetenerview recycleviewClickLisetenerview) {
        this.type = type;
...
//                .thumbnail(Glide.with(ctx).load(String.valueOf(R.raw.music_loading)))
        ...
        holder.card_total.setText(ut.getMusic_count());
