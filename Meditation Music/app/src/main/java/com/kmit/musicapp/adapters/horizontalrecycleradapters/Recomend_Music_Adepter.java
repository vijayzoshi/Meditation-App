 ...
 */
public class Recomend_Music_Adepter extends RecyclerView.Adapter<Recomend_Music_Adepter.MyViewHolder> {
    ...
    public Recomend_Music_Adepter(Context ctx, List<Played> recentslyPlayed, RecycleviewClickLisetenerview recycleviewClickLisetenerview) {
