package com.kmit.musicapp.notificationmanager;
...
public class AudioPlayerBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (action.equalsIgnoreCase("com.kmit.musicapp.ACTION_PLAY_PAUSE")) {
            try {
        ...
        } else if (action.equalsIgnoreCase("com.kmit.musicapp.ACTION_NEXT")) {
        ...
        } else if (action.equalsIgnoreCase("com.kmit.musicapp.ACTION_PREV")) {
            try {
